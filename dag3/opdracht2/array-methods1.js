...
//PS: Bij welk cijfer begint een array ookalweer met tellen? <<duh
...
const impeachTrumpSlice = (array) => array.slice(1,4);
      
const impeachTrumpSplice = (array) => array.splice(1,4);
...
//*ps: deze opdracht heb ik engels gelaten omdat er een dikke tip in zit over welke array method je gaat gebruiken. 
...
const combineArrays = (first,second) => console.log(first.concat(second));
